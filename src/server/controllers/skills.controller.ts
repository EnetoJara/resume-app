...
import { FailedResponse, SuccessResponse } from "../../types/types";
...
export class SkillsController {
    ...
    public getSkills (req: Request, res: Response): Bluebird<Response> {
    ...
    public getSkillsTypeById (req: Request, res: Response): Bluebird<Response> {
